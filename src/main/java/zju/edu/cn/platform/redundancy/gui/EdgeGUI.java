...
import zju.edu.cn.platform.redundancy.gui.button.*;
import zju.edu.cn.platform.redundancy.gui.propertyeditor.LinkEditor;
import zju.edu.cn.platform.redundancy.jsoninfo.config.DeviceConfig;
...
import zju.edu.cn.platform.redundancy.jsoninfo.config.LinkConfig;
import zju.edu.cn.platform.redundancy.jsoninfo.config.WirelessLinkConfig;
import zju.edu.cn.platform.redundancy.jsoninfo.generator.PositionGenerator;
import zju.edu.cn.platform.redundancy.jsoninfo.generator.SolutionConfigGenerator;
...
//        lblCost.setPreferredSize(new Dimension(60, 50));
        ...
        costField = new JTextFieldWithUnit("/s");
        costField.setBounds(100, 40, 80, 40,"");
        panel.add(costField);
        panel.add(costField.getUnitLabel());
...
//        lblDelay.setPreferredSize(new Dimension(60, 20));
        ...
        delayField.setBounds(300, 40, 80, 40,"");
        panel.add(delayField);
        panel.add(delayField.getUnitLabel());
    }
