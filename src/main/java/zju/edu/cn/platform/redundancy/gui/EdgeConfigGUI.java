...
import zju.edu.cn.platform.redundancy.jsoninfo.generator.EdgeGenerator;
import zju.edu.cn.platform.redundancy.jsoninfo.generator.LinkGenerator;
...
public class EdgeConfigGUI extends JPanel{
    ...
    public void setEdgeGenerator(PositionGenerator positionGenerator) {
        if(edgeNumField.getText().equals("") && appCapacityField.getText().equals("")){
